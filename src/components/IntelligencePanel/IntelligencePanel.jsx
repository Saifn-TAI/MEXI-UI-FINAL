...
export default function IntelligencePanel({
  ...
  originBizCard, onBackToBiz, originFuncCard, onBackToFunc, originAllSignals, onBackToAllSignals
}) {
  ...
  return (
    <div className={`intel-panel ${isLoading && prevSigRef.current ? 'ip-refreshing' : ''}`} id="intel-panel">
      ...
      <IPHeader
        ...
        onBackToFunc={onBackToFunc}
        originAllSignals={originAllSignals}
        onBackToAllSignals={onBackToAllSignals}
      />
