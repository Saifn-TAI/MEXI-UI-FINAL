    ...
    <>
      ...
      <div className="tb-user-container" ref={dropdownRef}>
        ...
        <div className={`tb-user-dropdown ${dropdownOpen ? 'show' : ''}`}>
          <button className="tb-dd-item" onClick={() => { setDropdownOpen(false); openProfile(); }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
            Profile
          </button>
          <button className="tb-dd-item" onClick={() => { setDropdownOpen(false); openSettings(); }}>
          ...
          <button className="tb-dd-item danger-item" onClick={() => { setDropdownOpen(false); onSignOut(); }}>
